	        ...
	        <security:authorize access="hasRole('ADMIN')">
		        <li class="nav-item">
		          ...
		          <ul id="delete-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
		            <li>
		              <a href="${pageContext.request.contextPath}/admin/deleteQna" class="active">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-striped">
							...
							<c:forEach var="delQna" varStatus="delQnaStatus" items="${delQnaList}">
								<tbody id="delEventTbody">									
									<tr>
										<th scope="row">
											<c:out value="${delQnaStatus.index+1}" />
										</th>
										<td class="btitle">
											<c:out value="${delQna.btitle}" />
										</td>
										<td class="bwriter">
											<c:out value="${delQna.bwriter}" />
										</td>
										<td class="bno">
											<c:out value="${delQna.bno}" />
										</td>
										<td class="bregDate">
											<c:out value="${delQna.bregDate}" />
										</td>
										<td class="delete">
				...
				$(this).css({ "opacity" : 0.5 })
					   .click(function() {
						   if($(this).attr("class") == "delete"){
							   window.location.href = "${pageContext.request.contextPath}/admin/deleteDetailQna?bno=" + $(this).parent("tr").children("td.bno").text().trim();
						   } else{
							   window.location.href = "${pageContext.request.contextPath}/qna/qnadetail?bno=" + $(this).parent("tr").children("td.bno").text().trim();
						   }
					   })	
			}, function() {
				$(this).css({ "opacity" : 1  });
