	                ...
	                <div class="panel-heading">
						...
						<div class="panel-body form-horizontal">
							<div class="form-group">
								...
								<button type="button" class="btn btn-info btn-frmModify" id="btnList" >취소</button>
								</div>
...
// });
	...
	$("#btnList").on("click", function(){
		...
		var targetFileName = $(".fileUploadResult ul li button").data("filename") ;
		var targetFileType = $(".fileUploadResult ul li button").data("filetype") ;
