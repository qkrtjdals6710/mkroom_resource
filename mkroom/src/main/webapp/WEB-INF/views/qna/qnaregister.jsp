               		...
               		<div class="row">
						<div class="form-group board1">
							...
							<div class="container">
								<div class="row">
								    <div class="col-lg-12" >
								    	<form role="form" action="${contextPath}/qna/qnaregister" method="post" name="frmBoard" id="frmBoard">
											...
											<div class="form-group">
												<label>작성자</label>
 												<input class="form-control" name="bwriter" value="${principal.username}" readonly="readonly">
 											</div>
											<div class="form-group">
												<label>내용</label>
...
function sendBoard() {
	...
	if( (btitle.length==0 ||btitle=="") ||
		...
		//frmBoard.action="${contextPath}/qna/qnaregister";
		//frmBoard.submit();
		return true ;
	}
}
...
$("#btnRegister").on("click", function(){
	...
	<%-- 취소 클릭 시 목록으로 되돌아가기 --%>	
	//취소 시, 업로드 파일 삭제 
	$("#btnToList").on("click", function name() {
	    ...
	    $(".fileUploadResult ul li span").each(function(i, obj) {
	      ...
	      formObj.attr("action","${contextPath}/qna/qnalist").attr("method","get");   
	      formObj.append(pageNumInput);
	      formObj.append(rowAmountPerPageInput) ;
	      formObj.append(scopeInput) ;
	      formObj.append(keywordInput) ;
