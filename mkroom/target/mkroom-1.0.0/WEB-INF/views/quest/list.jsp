      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-12 ftco-animate text-center mb-5">
            <h1 class="mb-3 bread">테마 / 예약하기</h1>
          </div>                
        </div>
      </div>			
    </div>
				...
				<div class="container">
					<div class="col-md-12">
						<form id="frmUp" action="${contextPath}/quest/detail">
							...
							&nbsp;&nbsp;
							<button type="button" class="btn btn-danger btn-sm" style="border: solid 1px;"><a href="${contextPath}/quest/list">조건 리셋</a></button>
						...
						<c:if test="${(questStatus.index % 2) == 0}">
							<div class="container">
								<div class="row" style="padding-left: 5%; padding-right: 5%; margin-top:100px; margin-bottom: 100px;">	
									<%-- 
										<c:if test="${questList[questStatus.index].delFlag == 0}"> --%>
											<%-- 한 사이클의 첫 번째 정보 --%>
											<div class="col-md-2">
											...
											<div class="col-md-4">
												<h3><c:out value="${questList[questStatus.index].questName}"/> </h3>
												<hr>
												<span>장르: 공포/스릴러</span>
												<div>
													<span>
										...
										</c:if> --%> <%-- 한 사이클의 첫 번째 정보의 delflag 체크 - end --%>
										
										
										<%-- 한 사이클의 두 번째 정보. 없을 수도 있으니 if 열어서 없으면 빈공간 처리 --%>
										<c:if test="${!questStatus.last}"><%-- 
											<c:if test="${questList[questStatus.index + 1].delFlag == 0}"> --%>
												<div class="col-md-2">
												...
												<div class="col-md-4">
													<h3><c:out value="${questList[(questStatus.index + 1)].questName}"/> </h3>
													<hr>
													<span>장르: 공포/스릴러</span>
													<div>
														<span>
											...
											</c:if> --%> <%-- 한 사이클의 두 번째 정보의 delflag 체크 - end --%>
