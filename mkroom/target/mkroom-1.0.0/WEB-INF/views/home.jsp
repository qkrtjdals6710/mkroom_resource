...
<p>
	<a href="${pageContext.request.contextPath }/contact">contact 오시는 길 및 연락</a>
</p>
...
<security:authorize access="hasRole('MEMBER')">
	<security:authentication var="principal" property="principal" />
	<p>
		<a href="${pageContext.request.contextPath}/payment?userId=${principal.username}">payment 결제</a>
	</p>
</security:authorize>
